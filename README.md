# Homework1
In this code review; I have assessed all of the code in the HTML and CSS, and made changes so that the code is easier to read from a Search engine optimization point of view. To do this, I changed all of the non-semantic elements 'div' to semantic elements such as 'header','section' and so forth.
